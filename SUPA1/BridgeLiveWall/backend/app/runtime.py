...
Domain routers should prefer FastAPI Depends() via app.core.deps.get_memory and
domain deps modules; this module remains the single process-wide source of truth
for instances used by lifespan, automation, and legacy call sites.
